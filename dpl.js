...
(function() {
  ...
  dpl.fitScale = function(ax, fn) {
    return function(g) {
      if (g.empty()) return;
      var set = dpl.frame(g), domain, calcDomain;
  ...
  dpl.setTitle = function(title, text) {
    return function(g) {
      g.each(function(d, i) {
        ...
        }).text(d3.functor(text)(d, i)).call(dpl.render);
      });
    };
  };
  if (!dpl.def) dpl.def = {};
  ...
  dpl.subplot = function(g, rows, cols, num) {
    ...
    subplots.enter().append("svg").call(dpl.chart()).attr("class", function(d, i) {
  ...
  dpl.lineEdit = function() {
    ...
    function lineEdit(g) {
      var chart = dpl.chart(g), line = g.append("path"), circles = g.append("g"), radius = 10, selected;
  ...
  dpl.chart = function(g) {
    ...
    chart.showAxes = function() {
      chart.back.call(dpl.showAxes.apply(chart, arguments));
      return chart;
    };
    chart.setTitle = function() {
      chart.overlay.call(dpl.setTitle.apply(chart, arguments));
      return chart;
    };
    chart.fitScale = function(ax, fn) {
      chart.all().call(dpl.fitScale(ax, fn));
      return chart;
    };
  ...
  if (typeof module !== "undefined") module.exports = dpl;
})();